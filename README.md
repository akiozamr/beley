...
![WhatsApp API](https://i.pinimg.com/736x/70/53/c9/7053c98d26873cd7f02b25faf24b93d4.jpg)
...
```bash
npm install @akiozamr/beley
```

Use the edge version (no guarantee of stability, but latest fixes + features)
```bash
yarn add @akiozamr/beley@latest
```

Then import your code using:
```javascript
const { default: makeWASocket } = require("@akiozamr/beley")
```
# Links
...
```javascript
const makeWASocket = require("@akiozamr/beley").default;
const { useMultiFileAuthState } = require("@akiozamr/beley");
...
```javascript
const makeWASocket = require("@akiozamr/beley").default;
const { useMultiFileAuthState, makeCacheableSignalKeyStore } = require("@akiozamr/beley");
...
```javascript
const makeWASocket = require("@akiozamr/beley").default;
const { DisconnectReason, useMultiFileAuthState } = require("@akiozamr/beley");
...
```javascript
const makeWASocket = require("@akiozamr/beley").default;
const { makeInMemoryStore } = require("@akiozamr/beley");
...
const { downloadMediaMessage, getContentType } = require("@akiozamr/beley");
